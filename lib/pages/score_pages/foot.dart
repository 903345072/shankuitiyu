...
class foot extends StatefulWidget {
  Function setDate;
  Function close_tab;
  foot({required this.setDate, super.key, required this.close_tab});
  @override
...
class footing extends State<foot> with TickerProviderStateMixin {
  ...
  _tarbarview() {
    return Expanded(
      child: TabBarView(controller: _tabC, children: [
        ...
        flowMatch(
          dataSourceFactory()
              .getFootDataSource("/common/score/getScoreFlowList"),
          setDate: (e) {
            widget.setDate(e);
          },
          key: flowkey,
