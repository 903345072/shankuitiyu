...
class basketSfList extends StatefulWidget {
  int? id;
  basketSfList({required this.id});
...
class ouzhiList_ extends State<basketSfList> {
  List data = [];
  ...
  getData() {
    G.api.game.getBasketPl({"id": widget.id, "type": 2}).then((value) {
      setState(() {
        data = value;
      });
    });
