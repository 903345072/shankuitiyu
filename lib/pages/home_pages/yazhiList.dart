...
class yazhiList extends StatefulWidget {
  int? id;
  yazhiList({required this.id});
...
class ouzhiList_ extends State<yazhiList> {
  List data = [];
  ...
  getData() {
    G.api.game.getFootPl({"id": widget.id, "type": 2}).then((value) {
      setState(() {
        data = value;
      });
    });
