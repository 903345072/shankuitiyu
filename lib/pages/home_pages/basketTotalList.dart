...
class basketTotalList extends StatefulWidget {
  int? id;
  basketTotalList({required this.id});
...
class ouzhiList_ extends State<basketTotalList> {
  List data = [];
  ...
  getData() {
    G.api.game.getBasketPl({"id": widget.id, "type": 3}).then((value) {
      setState(() {
        data = value;
      });
    });
