...
class ModelcompanyDiffDetail extends StatefulWidget {
  int? id;
  ModelcompanyDiffDetail({required this.id});
...
class indexChangeDetail_ extends State<ModelcompanyDiffDetail> {
  JcFootModel foot = JcFootModel.fromJson({
    "leagues": Map<String, dynamic>.from({}),
    "home_team": Map<String, dynamic>.from({}),
    "away_team": Map<String, dynamic>.from({})
