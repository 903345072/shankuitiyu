...
class basketRfList extends StatefulWidget {
  int? id;
  basketRfList({required this.id});
...
class ouzhiList_ extends State<basketRfList> {
  List data = [];
  ...
  getData() {
    G.api.game.getBasketPl({"id": widget.id, "type": 1}).then((value) {
      setState(() {
        data = value;
      });
    });
