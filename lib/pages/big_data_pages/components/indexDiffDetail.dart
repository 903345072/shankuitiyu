...
class indexDiffDetail extends StatefulWidget {
  int id;
  indexDiffDetail({required this.id});
...
class indexChangeDetail_ extends State<indexDiffDetail> {
  JcFootModel foot = JcFootModel.fromJson({
    "leagues": Map<String, dynamic>.from({}),
    "home_team": Map<String, dynamic>.from({}),
    "away_team": Map<String, dynamic>.from({})
