...
class indexDiff extends StatefulWidget {
  String price = "0";
  int buy_count = 0;
  indexDiff({required this.price, required this.buy_count});
  @override
...
class dataReport_ extends State<indexDiff> {
  ...
  getIsBuy() {
    G.api.user.getIsBuy({"id": 4}).then((value) {
      setState(() {
  ...
  Future getGameList() async {
    return await G.api.game.getDifferenceData(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              TextWidget(
                                                '${data[index]["cur_index_diff"]["jigou_count"]}',
                                                fontSize: rpx(11),
                                                color: Colors.red,
                                              ),
                                              TextWidget(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            TextWidget(
                                              '主胜${(data[index]["win_rate"] * 100).toStringAsFixed(0)}%',
                                              color: Colors.red,
                                              fontSize: rpx(15),
                                            ),
                                            TextWidget(
                                              '平${(100 - (data[index]["loss_rate"] * 100) - (data[index]["win_rate"] * 100)).toStringAsFixed(0)}%',
                                              color: Colors.red,
                                              fontSize: rpx(15),
                                            ),
                                            TextWidget(
                                              '客胜${(data[index]["loss_rate"] * 100).toStringAsFixed(0)}%',
                                              color: Colors.red,
                                              fontSize: rpx(15),
                                            )
                                          ],
