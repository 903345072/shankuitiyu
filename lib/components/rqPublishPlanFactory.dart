...
class rqPublishPlanFactory implements publishPlanFactory {
  ...
  List<JcFootModel> getValidCheckList(List<JcFootModel> list) {
    ...
    return list.where((element) {
      Map<String, Rq> footrq = element.jcFootMetModel_!.footrq!;
