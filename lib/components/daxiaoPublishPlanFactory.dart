...
class daxiaoPublishPlanFactory implements publishPlanFactory {
  ...
  List<JcFootModel> getValidCheckList(List<JcFootModel> list) {
    ...
    return list.where((element) {
      Map<String, Rq> dxq = element.jcFootMetModel_!.daxiaoqiu!;
