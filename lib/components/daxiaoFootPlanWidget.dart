...
class daxiaoFootPlanWidget extends StatefulWidget {
  JcFootModel j;
  Function changeGame;
  Function deleteGame;
  int index;
  daxiaoFootPlanWidget(
      {super.key,
      required this.j,
...
class plan_ extends State<daxiaoFootPlanWidget> {
  @override
  ...
  getRq() {
    List<Rq> rq = widget.j.jcFootMetModel_!.daxiaoqiu!.values.toList();
    if (rq[0].pl == '0') {
      return Container();
    }
    return Row(
      ...
      children: [
        Container(
          ...
          child: TextWidget(
            widget.j.jcFootMetModel_!.daxiaoNum.toString(),
            fontSize: rpx(13),
          ),
        ),
        Row(
